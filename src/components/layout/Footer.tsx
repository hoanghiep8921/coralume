  ...
  return (
    <footer className="bg-primary py-[var(--spacing-stack-lg)] mt-24">
      <div className="flex flex-col md:flex-row justify-between items-center px-[var(--spacing-margin-mobile)] md:px-[var(--spacing-margin-desktop)] w-full max-w-[var(--spacing-container-max)] mx-auto gap-8">
        ...
        {/* Right: Social Icons — SRS 7.3: Facebook, Instagram, TikTok */}
        <div className="flex gap-4">
          <a
            href="https://facebook.com/coralume_official"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary hover:scale-110 transition-all duration-fast cursor-pointer"
            aria-label="Facebook"
          >
          ...
          <a
            href="https://instagram.com/coralume_official"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary hover:scale-110 transition-all duration-fast cursor-pointer"
          ...
          <a
            href="https://tiktok.com/@coralume_official"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-secondary hover:scale-110 transition-all duration-fast cursor-pointer"
            aria-label="TikTok"
