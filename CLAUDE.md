...
- `Coralume-SRS.md` — Software Requirements Specification (chi tiết 12 trang, 5 roles, 12 entities, ~60 APIs, user flows, milestones)
- `Coralume-Design-Spec.md` — Design Specification (colors, typography, responsive, animation, icons, media, accessibility)